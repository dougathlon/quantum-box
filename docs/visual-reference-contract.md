...
**Status:** binding implementation and review contract, revised 2026-09-05
...
physical title remains a reviewed raster composition. Internal
menus and games remain code-native at `320×180`.
...
| ------------------------- | -------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Physical title            | the decomposed reviewed layers in `src/assets/brown-box/`                                                                        | Preserve the worn wooden device and Formica table. Keep the screen field and local `QUANTUM BOX` / `PRESS START` copy separately replaceable and sharp. The photographic room/device surround is the sole approved exception to the internal three-colour rule.                                                                                                                                                              |
...
| Arcade selection          | sharp runtime bitmap UI, derived from `core-asset-language-v1/screens/menu-arcade-selected-320x180.png`                          | Separate all-open five-cabinet screen. Thumbnails and controls use only the three-colour grammar. Enclose is absent.                                                                                                                                                                                                                                                                                                         |
...
| Workshop                  | Four formula bays plus final MOTH link                                                                                           | Use four large, quiet engine rows within the standard menu frame. Do not repeat the page title, invent extra bays, or expose dense formula copy before the player selects a recovered bay.                                                                                                                                                                                                                                   |
